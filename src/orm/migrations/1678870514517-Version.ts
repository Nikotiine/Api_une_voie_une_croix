...
export class Version1678870514517 implements MigrationInterface {
    name = 'Version1678870514517'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`route\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`height\` int NOT NULL, \`quickdraw\` int NOT NULL, \`isActive\` tinyint NOT NULL, \`createdAt\` datetime NOT NULL, \`updatedAt\` datetime NULL, \`levelId\` bigint NULL, \`secteurId\` bigint NULL, \`equipmentId\` bigint NULL, \`engagementId\` bigint NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
